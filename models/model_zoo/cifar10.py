...
from models.architectures.dm_wide_resnet import (
    CIFAR10_MEAN,
    CIFAR10_STD,
    DMWideResNet,
    Swish,
...
from models.architectures.resnest import ResNest152
from models.architectures.wide_resnet import WideResNet
from models.architectures.robust_wide_resnet import RobustWideResNet
from models.architectures.boosting_wide_resnet import BoostingWideResNet
from models.architectures.CARD_resnet import LRR_ResNet, WidePreActResNet
from models.architectures.paf_wide_resnet import pssilu_wrn_28_10
from models.architectures.sodef_layers import rebuffi_sodef
from models.architectures import xcit
from models.architectures import robust_resnet
from models.architectures.comp_model import (
    get_composite_model,
    get_nonlin_mixed_classifier,
)
from models.architectures.robustarch_wide_resnet import (
    get_model as get_robustarch_model,
)
...
class Hendrycks2019UsingNet(WideResNet):
    def __init__(self, depth=28, widen_factor=10):
        super(Hendrycks2019UsingNet, self).__init__(
            depth=depth, widen_factor=widen_factor, sub_block1=False
        )
...
class Rice2020OverfittingNet(WideResNet):
    def __init__(self, depth=34, widen_factor=20):
        ...
        self.register_buffer(
            "sigma", torch.tensor([0.2471, 0.2435, 0.2616]).view(1, 3, 1, 1)
        )
...
class Ding2020MMANet(WideResNet):
    ...
    def __init__(self, depth=28, widen_factor=4):
        super(Ding2020MMANet, self).__init__(
            depth=depth, widen_factor=widen_factor, sub_block1=False
        )
...
class Augustin2020AdversarialWideNet(WideResNet):
    def __init__(self, depth=34, widen_factor=10):
        super(Augustin2020AdversarialWideNet, self).__init__(
            depth=depth, widen_factor=widen_factor, sub_block1=False
        )
        self.register_buffer(
            "mu",
...
class Rice2020OverfittingNetL2(PreActResNet):
    def __init__(self):
        super(Rice2020OverfittingNetL2, self).__init__(
            PreActBlockV2, [2, 2, 2, 2], bn_before_fc=True
        )
        self.register_buffer(
            "mu", torch.tensor([0.4914, 0.4822, 0.4465]).view(1, 3, 1, 1)
        )
...
class Rony2019DecouplingNet(WideResNet):
    def __init__(self, depth=28, widen_factor=10):
        super(Rony2019DecouplingNet, self).__init__(
            depth=depth, widen_factor=widen_factor, sub_block1=False
        )
        self.register_buffer("mu", torch.tensor([0.491, 0.482, 0.447]).view(1, 3, 1, 1))
        self.register_buffer(
            "sigma", torch.tensor([0.247, 0.243, 0.262]).view(1, 3, 1, 1)
        )
...
class Kireev2021EffectivenessNet(PreActResNet):
    def __init__(self):
        super(Kireev2021EffectivenessNet, self).__init__(
            PreActBlockV2, [2, 2, 2, 2], bn_before_fc=True
        )
        self.register_buffer(
            "mu", torch.tensor([0.4914, 0.4822, 0.4465]).view(1, 3, 1, 1)
...
linf = OrderedDict(
    [
        ...
        (
            ...
            {
                "model": lambda: WideResNet(depth=34, widen_factor=15, sub_block1=True),
        ...
        (
            "Wang2023Better_WRN-28-10",
            {
                ...
                "gdrive_id": "1-6MYKJdECDVGaWjj6GgqvaT95BGKhUvI",
            },
        ),
        (
            "Wang2023Better_WRN-70-16",
            {
                ...
                "gdrive_id": "1-RF7ZSS-PAh6bfQcuqx4lh9bc9BUGnap",
            },
        ),
        (
            "Xu2023Exploring_WRN-28-10",
            {
                ...
                "gdrive_id": "1k1uJI13ft0h0dfzuEihVpBvjBXwFRH2o",
            },
        ),
        (
            "Cui2023Decoupled_WRN-28-10",
            {
                ...
                "gdrive_id": "1-AaTrYt23WJFR22hXgBd-i6kjpsz6Hf2",
            },
        ),
        (
            "Cui2023Decoupled_WRN-34-10",
            {
                ...
                "gdrive_id": "1-ArD-TugRXUbH3VtM9qnzvby6NvdXNUN",
            },
        ),
        (
            "Bai2023Improving_edm",
            {
                "model": lambda: get_composite_model(
                    "edm", "cifar10"
                ),  # TODO: check device calls.
                "gdrive_id": [
        ...
        (
            "Peng2023Robust",
            {
                "model": lambda: get_robustarch_model(
                    "ra_wrn70_16"
                ),  # TODO: check device calls.
        ...
        (
            "Bai2024MixedNUTS",
            {
                "model": lambda: get_nonlin_mixed_classifier(
                    "cifar10"
                ),  # TODO: check device calls.
                "gdrive_id": [
                    "1-5EwY_5tQZudo9idwXiUGr3P4OUUGaQN",
    ...
    [
        ...
        (
            "Wang2023Better_WRN-28-10",
            {
                ...
                "gdrive_id": "1-fwKiJXEqHHUngt8wKsNnHuD4vAPvPXC",
            },
        ),
        (
            "Wang2023Better_WRN-70-16",
            {
                ...
                "gdrive_id": "101UyURyte05tJLA9VFRBN6UDLyn-0sJw",
            },
        ),
    ]
)
